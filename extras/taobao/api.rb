  ...
  class Api
    class << self
      ...
      def taobao_users_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['users'] = ( result_hash['users'].blank? ? [] : result_hash['users']['user'] )
      ...
      def taobao_itemcats_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['item_cats'] = ( result_hash['item_cats'].blank? ? [] : result_hash['item_cats']['item_cat'] )
      ...
      def taobao_itemcats_increment_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['item_cats'] = ( result_hash['item_cats'].blank? ? [] : result_hash['item_cats']['item_cat'] )
        result_hash['item_props'] = ( result_hash['item_props'].blank? ? [] : result_hash['item_props']['item_prop'] )
        result_hash['prop_values'] = ( result_hash['prop_values'].blank? ? [] : result_hash['prop_values']['prop_value'] )
      ...
      def taobao_aftersale_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['after_sales'] = ( result_hash['after_sales'].blank? ? [] : result_hash['after_sales']['after_sale'] )
      ...
      def taobao_item_anchor_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['anchor_modules'] = ( result_hash['anchor_modules'].blank? ? [] : result_hash['anchor_modules']['ids_module'] )

        result_hash
      end

      def taobao_item_bseller_add(params)
        params['method'] = 'taobao.item.bseller.add'
        required_check_result = ["auction_point", "cid", "desc", "location.city", "location.state", "num", "price", "stuff_status", "title", "type"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
        special_params = ["product_id"]
        special_check_result = special_params - params.keys.map(&:to_s)
        raise "#{special_params.inspect} 为应用级特殊参数,具体请查看此API文档" if special_params.size == special_check_result.size
      ...
      def taobao_item_cseller_add(params)
        params['method'] = 'taobao.item.cseller.add'
        required_check_result = ["cid", "desc", "location.city", "location.state", "num", "price", "stuff_status", "title", "type"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_item_skus_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['skus'] = ( result_hash['skus'].blank? ? [] : result_hash['skus']['sku'] )
      ...
      def taobao_item_templates_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['item_template_list'] = ( result_hash['item_template_list'].blank? ? [] : result_hash['item_template_list']['item_template'] )
      ...
      def taobao_items_custom_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['items'] = ( result_hash['items'].blank? ? [] : result_hash['items']['item'] )
      ...
      def taobao_products_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['products'] = ( result_hash['products'].blank? ? [] : result_hash['products']['product'] )
      ...
      def tmall_brandcat_salespro_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['cat_brand_sale_props'] = ( result_hash['cat_brand_sale_props'].blank? ? [] : result_hash['cat_brand_sale_props']['cat_brand_sale_prop'] )
      ...
      def taobao_trades_sold_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['trades'] = ( result_hash['trades'].blank? ? [] : result_hash['trades']['trade'] )
      ...
      def taobao_traderates_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['trade_rates'] = ( result_hash['trade_rates'].blank? ? [] : result_hash['trade_rates']['trade_rate'] )
      ...
      def taobao_areas_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['areas'] = ( result_hash['areas'].blank? ? [] : result_hash['areas']['area'] )
      ...
      def taobao_delivery_template_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['delivery_templates'] = ( result_hash['delivery_templates'].blank? ? [] : result_hash['delivery_templates']['delivery_template'] )
      ...
      def taobao_logistics_address_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['addresses'] = ( result_hash['addresses'].blank? ? [] : result_hash['addresses']['address_result'] )
      ...
      def taobao_logistics_companies_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['logistics_companies'] = ( result_hash['logistics_companies'].blank? ? [] : result_hash['logistics_companies']['logistics_company'] )
      ...
      def taobao_logistics_orders_detail_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['shippings'] = ( result_hash['shippings'].blank? ? [] : result_hash['shippings']['shipping'] )
      ...
      def taobao_logistics_partners_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['logistics_partners'] = ( result_hash['logistics_partners'].blank? ? [] : result_hash['logistics_partners']['logistics_partner'] )
      ...
      def taobao_logistics_trace_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['trace_list'] = ( result_hash['trace_list'].blank? ? [] : result_hash['trace_list']['transit_step_info'] )
      ...
      def taobao_sellercats_list_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['seller_cats'] = ( result_hash['seller_cats'].blank? ? [] : result_hash['seller_cats']['seller_cat'] )
      ...
      def taobao_shopcats_list_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['shop_cats'] = ( result_hash['shop_cats'].blank? ? [] : result_hash['shop_cats']['shop_cat'] )

        result_hash
      end

      def taobao_fenxiao_cooperation_audit(params)
        params['method'] = 'taobao.fenxiao.cooperation.audit'
        required_check_result = ["audit_result", "remark", "requisition_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_cooperation_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['cooperations'] = ( result_hash['cooperations'].blank? ? [] : result_hash['cooperations']['cooperation'] )

        result_hash
      end

      def taobao_fenxiao_cooperation_productcat_add(params)
        params['method'] = 'taobao.fenxiao.cooperation.productcat.add'
        required_check_result = ["cooperate_id", "product_line_list"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_cooperation_terminate(params)
        params['method'] = 'taobao.fenxiao.cooperation.terminate'
        required_check_result = ["cooperate_id", "end_remain_days", "end_remark"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_discounts_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['discounts'] = ( result_hash['discounts'].blank? ? [] : result_hash['discounts']['discount'] )

        result_hash
      end

      def taobao_fenxiao_distributor_archives_get(params)
        params['method'] = 'taobao.fenxiao.distributor.archives.get'
        required_check_result = ["distributor_user_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_distributor_items_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['records'] = ( result_hash['records'].blank? ? [] : result_hash['records']['fenxiao_item_record'] )

        result_hash
      end

      def taobao_fenxiao_distributor_procuct_static_get(params)
        params['method'] = 'taobao.fenxiao.distributor.procuct.static.get'
        required_check_result = ["distributor_user_id", "product_id_array"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['distributor_item_flows'] = ( result_hash['distributor_item_flows'].blank? ? [] : result_hash['distributor_item_flows']['distributor_item_flow'] )
      ...
      def taobao_fenxiao_distributors_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['distributors'] = ( result_hash['distributors'].blank? ? [] : result_hash['distributors']['distributor'] )

        result_hash
      end

      def taobao_fenxiao_grade_add(params)
        params['method'] = 'taobao.fenxiao.grade.add'
        required_check_result = ["name"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_grade_delete(params)
        params['method'] = 'taobao.fenxiao.grade.delete'
        required_check_result = ["grade_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_grade_update(params)
        params['method'] = 'taobao.fenxiao.grade.update'
        required_check_result = ["grade_id", "name"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_grades_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['fenxiao_grades'] = ( result_hash['fenxiao_grades'].blank? ? [] : result_hash['fenxiao_grades']['fenxiao_grade'] )
      ...
      def taobao_fenxiao_order_close(params)
        params['method'] = 'taobao.fenxiao.order.close'
      ...
      def taobao_fenxiao_order_create_dealer(params)
        params['method'] = 'taobao.fenxiao.order.create.dealer'
        required_check_result = ["addr", "buyer_name", "logistic_fee", "logistic_type", "outer_id", "pay_type", "province", "sub_order_detail"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
        special_params = ["city", "country"]
        special_check_result = special_params - params.keys.map(&:to_s)
        raise "#{special_params.inspect} 为应用级特殊参数,具体请查看此API文档" if special_params.size == special_check_result.size
      ...
      def taobao_fenxiao_order_pay(params)
        params['method'] = 'taobao.fenxiao.order.pay'
        required_check_result = ["message", "purchase_order_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_orders_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['purchase_orders'] = ( result_hash['purchase_orders'].blank? ? [] : result_hash['purchase_orders']['purchase_order'] )
      ...
      def taobao_fenxiao_product_gradeprice_get(params)
        params['method'] = 'taobao.fenxiao.product.gradeprice.get'
        required_check_result = ["product_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['grade_discounts'] = ( result_hash['grade_discounts'].blank? ? [] : result_hash['grade_discounts']['grade_discount'] )
      ...
      def taobao_fenxiao_product_map_add(params)
        params['method'] = 'taobao.fenxiao.product.map.add'
        required_check_result = ["product_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_product_map_delete(params)
        params['method'] = 'taobao.fenxiao.product.map.delete'
        required_check_result = ["product_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_product_skus_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['skus'] = ( result_hash['skus'].blank? ? [] : result_hash['skus']['fenxiao_sku'] )
      ...
      def taobao_fenxiao_productcat_add(params)
        params['method'] = 'taobao.fenxiao.productcat.add'
        required_check_result = ["agent_cost_percent", "dealer_cost_percent", "name", "retail_high_percent", "retail_low_percent"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_productcat_delete(params)
        params['method'] = 'taobao.fenxiao.productcat.delete'
        required_check_result = ["product_line_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_productcat_update(params)
        params['method'] = 'taobao.fenxiao.productcat.update'
        required_check_result = ["product_line_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_fenxiao_productcats_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['productcats'] = ( result_hash['productcats'].blank? ? [] : result_hash['productcats']['product_cat'] )
      ...
      def taobao_fenxiao_products_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['products'] = ( result_hash['products'].blank? ? [] : result_hash['products']['fenxiao_product'] )

        result_hash
      end

      def taobao_fenxiao_requisitions_get(params)
        params['method'] = 'taobao.fenxiao.requisitions.get'

        result_hash = Client.execute(params)
        result_hash['requisitions'] = ( result_hash['requisitions'].blank? ? [] : result_hash['requisitions']['requisition'] )
      ...
      def taobao_fenxiao_trademonitor_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['trade_monitors'] = ( result_hash['trade_monitors'].blank? ? [] : result_hash['trade_monitors']['trade_monitor'] )

        result_hash
      end

      def taobao_inventory_adjust_external(params)
        params['method'] = 'taobao.inventory.adjust.external'
        required_check_result = ["biz_type", "biz_unique_code", "items", "operate_time", "operate_type", "store_code"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['tip_infos'] = ( result_hash['tip_infos'].blank? ? [] : result_hash['tip_infos']['tip_info'] )

        result_hash
      end

      def taobao_inventory_adjust_trade(params)
        params['method'] = 'taobao.inventory.adjust.trade'
        required_check_result = ["biz_unique_code", "items", "operate_time", "tb_order_type"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_inventory_authorize_get(params)
        params['method'] = 'taobao.inventory.authorize.get'
        required_check_result = ["authorize_code"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['authorize_list'] = ( result_hash['authorize_list'].blank? ? [] : result_hash['authorize_list']['inventory_authorize_info'] )

        result_hash
      end

      def taobao_inventory_authorize_getall(params)
        params['method'] = 'taobao.inventory.authorize.getall'
        required_check_result = ["sc_item_id_list"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_inventory_authorize_remove(params)
        params['method'] = 'taobao.inventory.authorize.remove'
        required_check_result = ["authorize_code", "user_nick_list"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_inventory_authorize_removeall(params)
        params['method'] = 'taobao.inventory.authorize.removeall'
        required_check_result = ["sc_item_id_list"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_inventory_authorize_set(params)
        params['method'] = 'taobao.inventory.authorize.set'
        required_check_result = ["authorize_type", "items"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['authorize_results'] = ( result_hash['authorize_results'].blank? ? [] : result_hash['authorize_results']['inventory_authorize_info'] )
        result_hash['tip_infos'] = ( result_hash['tip_infos'].blank? ? [] : result_hash['tip_infos']['tip_info'] )

        result_hash
      end

      def taobao_inventory_initial(params)
        params['method'] = 'taobao.inventory.initial'
        required_check_result = ["items", "store_code"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_inventory_occupy_apply(params)
        params['method'] = 'taobao.inventory.occupy.apply'
        required_check_result = ["biz_type", "biz_unique_code", "items", "occupy_time", "occupy_type", "store_code"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_inventory_occupy_cancel(params)
        params['method'] = 'taobao.inventory.occupy.cancel'
        required_check_result = ["biz_unique_code", "operate_code", "store_code"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_inventory_query(params)
        params['method'] = 'taobao.inventory.query'
        required_check_result = ["sc_item_ids"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['item_inventorys'] = ( result_hash['item_inventorys'].blank? ? [] : result_hash['item_inventorys']['inventory_sum'] )
        result_hash['tip_infos'] = ( result_hash['tip_infos'].blank? ? [] : result_hash['tip_infos']['tip_info'] )

        result_hash
      end

      def taobao_inventory_store_manage(params)
        params['method'] = 'taobao.inventory.store.manage'
        required_check_result = ["address", "address_area_name", "operate_type", "store_code", "store_name", "store_type"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['store_list'] = ( result_hash['store_list'].blank? ? [] : result_hash['store_list']['store'] )

        result_hash
      end

      def taobao_inventory_store_query(params)
        params['method'] = 'taobao.inventory.store.query'
      ...
      def taobao_scitem_add(params)
        params['method'] = 'taobao.scitem.add'
        required_check_result = ["item_name", "outer_code"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_scitem_get(params)
        params['method'] = 'taobao.scitem.get'
        required_check_result = ["item_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_scitem_map_add(params)
        params['method'] = 'taobao.scitem.map.add'
        required_check_result = ["item_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_scitem_map_delete(params)
        params['method'] = 'taobao.scitem.map.delete'
        required_check_result = ["sc_item_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_scitem_map_query(params)
        params['method'] = 'taobao.scitem.map.query'
        required_check_result = ["item_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['sc_item_maps'] = ( result_hash['sc_item_maps'].blank? ? [] : result_hash['sc_item_maps']['sc_item_map'] )

        result_hash
      end

      def taobao_scitem_outercode_get(params)
        params['method'] = 'taobao.scitem.outercode.get'
        required_check_result = ["outer_code"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_scitem_query(params)
        params['method'] = 'taobao.scitem.query'

        result_hash = Client.execute(params)
        result_hash['sc_item_list'] = ( result_hash['sc_item_list'].blank? ? [] : result_hash['sc_item_list']['sc_item'] )

        result_hash
      end

      def taobao_scitem_update(params)
        params['method'] = 'taobao.scitem.update'
        required_check_result = ["item_type"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
        special_params = ["outer_code"]
        special_check_result = special_params - params.keys.map(&:to_s)
        raise "#{special_params.inspect} 为应用级特殊参数,具体请查看此API文档" if special_params.size == special_check_result.size
      ...
      def taobao_wangwang_eservice_avgwaittime_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['waiting_time_list_on_days'] = ( result_hash['waiting_time_list_on_days'].blank? ? [] : result_hash['waiting_time_list_on_days']['waiting_times_on_day'] )
      ...
      def taobao_wangwang_eservice_chatlog_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['msgs'] = ( result_hash['msgs'].blank? ? [] : result_hash['msgs']['msg'] )
      ...
      def taobao_wangwang_eservice_chatpeers_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['chatpeers'] = ( result_hash['chatpeers'].blank? ? [] : result_hash['chatpeers']['chatpeer'] )
      ...
      def taobao_wangwang_eservice_evals_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['staff_eval_details'] = ( result_hash['staff_eval_details'].blank? ? [] : result_hash['staff_eval_details']['eval_detail'] )
      ...
      def taobao_wangwang_eservice_evaluation_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['staff_eval_stat_on_days'] = ( result_hash['staff_eval_stat_on_days'].blank? ? [] : result_hash['staff_eval_stat_on_days']['staff_eval_stat_on_day'] )
      ...
      def taobao_wangwang_eservice_groupmember_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['group_member_list'] = ( result_hash['group_member_list'].blank? ? [] : result_hash['group_member_list']['group_member'] )
      ...
      def taobao_wangwang_eservice_loginlogs_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['loginlogs'] = ( result_hash['loginlogs'].blank? ? [] : result_hash['loginlogs']['login_log'] )
      ...
      def taobao_wangwang_eservice_noreplynum_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['non_reply_stat_on_days'] = ( result_hash['non_reply_stat_on_days'].blank? ? [] : result_hash['non_reply_stat_on_days']['non_reply_stat_on_day'] )
      ...
      def taobao_wangwang_eservice_onlinetime_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['online_times_list_on_days'] = ( result_hash['online_times_list_on_days'].blank? ? [] : result_hash['online_times_list_on_days']['online_times_on_day'] )
      ...
      def taobao_wangwang_eservice_receivenum_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['reply_stat_list_on_days'] = ( result_hash['reply_stat_list_on_days'].blank? ? [] : result_hash['reply_stat_list_on_days']['reply_stat_on_day'] )
      ...
      def taobao_wangwang_eservice_streamweigths_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['staff_stream_weights'] = ( result_hash['staff_stream_weights'].blank? ? [] : result_hash['staff_stream_weights']['stream_weight'] )
      ...
      def taobao_taobaoke_items_coupon_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['taobaoke_items'] = ( result_hash['taobaoke_items'].blank? ? [] : result_hash['taobaoke_items']['taobaoke_item'] )
      ...
      def taobao_taobaoke_items_detail_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['taobaoke_item_details'] = ( result_hash['taobaoke_item_details'].blank? ? [] : result_hash['taobaoke_item_details']['taobaoke_item_detail'] )
      ...
      def taobao_taobaoke_shops_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['taobaoke_shops'] = ( result_hash['taobaoke_shops'].blank? ? [] : result_hash['taobaoke_shops']['taobaoke_shop'] )
      ...
      def taobao_comet_discardinfo_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['discard_info_list'] = ( result_hash['discard_info_list'].blank? ? [] : result_hash['discard_info_list']['discard_info'] )
      ...
      def taobao_increment_authorize_message_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['messages'] = ( result_hash['messages'].blank? ? [] : result_hash['messages'].values.flatten(1)  )
      ...
      def taobao_increment_customers_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['app_customers'] = ( result_hash['app_customers'].blank? ? [] : result_hash['app_customers']['app_customer'] )
      ...
      def taobao_increment_items_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['notify_items'] = ( result_hash['notify_items'].blank? ? [] : result_hash['notify_items']['notify_item'] )
      ...
      def taobao_increment_refunds_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['notify_refunds'] = ( result_hash['notify_refunds'].blank? ? [] : result_hash['notify_refunds']['notify_refund'] )
      ...
      def taobao_increment_trades_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['notify_trades'] = ( result_hash['notify_trades'].blank? ? [] : result_hash['notify_trades']['notify_trade'] )
      ...
      def taobao_topats_tasks_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['tasks'] = ( result_hash['tasks'].blank? ? [] : result_hash['tasks']['task'] )
      ...
      def taobao_wlb_inventory_detail_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['inventory_list'] = ( result_hash['inventory_list'].blank? ? [] : result_hash['inventory_list']['wlb_inventory'] )
      ...
      def taobao_wlb_inventorylog_query(params)
        ...
        result_hash = Client.execute(params)
        result_hash['inventory_log_list'] = ( result_hash['inventory_log_list'].blank? ? [] : result_hash['inventory_log_list']['wlb_item_inventory_log'] )
      ...
      def taobao_wlb_item_authorization_add(params)
        ...
        result_hash = Client.execute(params)
        result_hash['rule_id_list'] = ( result_hash['rule_id_list'].blank? ? [] : result_hash['rule_id_list'].values.flatten(1)  )
      ...
      def taobao_wlb_item_authorization_query(params)
        ...
        result_hash = Client.execute(params)
        result_hash['authorization_list'] = ( result_hash['authorization_list'].blank? ? [] : result_hash['authorization_list']['wlb_authorization'] )
      ...
      def taobao_wlb_item_batch_query(params)
        ...
        result_hash = Client.execute(params)
        result_hash['item_inventory_batch_list'] = ( result_hash['item_inventory_batch_list'].blank? ? [] : result_hash['item_inventory_batch_list']['wlb_item_batch_inventory'] )
      ...
      def taobao_wlb_item_combination_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['item_id_list'] = ( result_hash['item_id_list'].blank? ? [] : result_hash['item_id_list'].values.flatten(1)  )
      ...
      def taobao_wlb_item_consignment_page_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['wlb_consign_ments'] = ( result_hash['wlb_consign_ments'].blank? ? [] : result_hash['wlb_consign_ments']['wlb_consign_ment'] )
      ...
      def taobao_wlb_item_map_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['out_entity_item_list'] = ( result_hash['out_entity_item_list'].blank? ? [] : result_hash['out_entity_item_list']['out_entity_item'] )
      ...
      def taobao_wlb_item_query(params)
        ...
        result_hash = Client.execute(params)
        result_hash['item_list'] = ( result_hash['item_list'].blank? ? [] : result_hash['item_list']['wlb_item'] )
      ...
      def taobao_wlb_notify_message_page_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['wlb_messages'] = ( result_hash['wlb_messages'].blank? ? [] : result_hash['wlb_messages']['wlb_message'] )
      ...
      def taobao_wlb_order_page_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['order_list'] = ( result_hash['order_list'].blank? ? [] : result_hash['order_list']['wlb_order'] )
      ...
      def taobao_wlb_orderitem_page_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['order_item_list'] = ( result_hash['order_item_list'].blank? ? [] : result_hash['order_item_list']['wlb_order_item'] )
      ...
      def taobao_wlb_orderschedulerule_query(params)
        ...
        result_hash = Client.execute(params)
        result_hash['order_schedule_rule_list'] = ( result_hash['order_schedule_rule_list'].blank? ? [] : result_hash['order_schedule_rule_list']['wlb_order_schedule_rule'] )
      ...
      def taobao_wlb_orderstatus_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['wlb_order_status'] = ( result_hash['wlb_order_status'].blank? ? [] : result_hash['wlb_order_status']['wlb_process_status'] )
      ...
      def taobao_wlb_replenish_statistics(params)
        ...
        result_hash = Client.execute(params)
        result_hash['replenish_list'] = ( result_hash['replenish_list'].blank? ? [] : result_hash['replenish_list']['wlb_replenish'] )
      ...
      def taobao_wlb_subscription_query(params)
        ...
        result_hash = Client.execute(params)
        result_hash['seller_subscription_list'] = ( result_hash['seller_subscription_list'].blank? ? [] : result_hash['seller_subscription_list']['wlb_seller_subscription'] )
      ...
      def taobao_wlb_tmsorder_query(params)
        ...
        result_hash = Client.execute(params)
        result_hash['tms_order_list'] = ( result_hash['tms_order_list'].blank? ? [] : result_hash['tms_order_list']['wlb_tms_order'] )
      ...
      def taobao_wlb_tradeorder_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['wlb_order_list'] = ( result_hash['wlb_order_list'].blank? ? [] : result_hash['wlb_order_list']['wlb_order'] )
      ...
      def taobao_simba_adgroup_adgroupcatmatchs_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['adgroup_catmatch_list'] = ( result_hash['adgroup_catmatch_list'].blank? ? [] : result_hash['adgroup_catmatch_list']['ad_group_catmatch'] )
      ...
      def taobao_simba_adgroup_nonsearchprices_update(params)
        ...
        result_hash = Client.execute(params)
        result_hash['adgroup_list'] = ( result_hash['adgroup_list'].blank? ? [] : result_hash['adgroup_list']['ad_group'] )
      ...
      def taobao_simba_adgroupids_changed_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['changed_adgroupids'] = ( result_hash['changed_adgroupids'].blank? ? [] : result_hash['changed_adgroupids'].values.flatten(1)  )
      ...
      def taobao_simba_adgroupids_deleted_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['deleted_adgroup_ids'] = ( result_hash['deleted_adgroup_ids'].blank? ? [] : result_hash['deleted_adgroup_ids'].values.flatten(1)  )
      ...
      def taobao_simba_campaign_areaoptions_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['area_options'] = ( result_hash['area_options'].blank? ? [] : result_hash['area_options']['area_option'] )
      ...
      def taobao_simba_campaign_channeloptions_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['channel_options'] = ( result_hash['channel_options'].blank? ? [] : result_hash['channel_options']['channel_option'] )
      ...
      def taobao_simba_campaigns_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['campaigns'] = ( result_hash['campaigns'].blank? ? [] : result_hash['campaigns']['campaign'] )
      ...
      def taobao_simba_catmatchids_changed_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['changed_catmatch_ids'] = ( result_hash['changed_catmatch_ids'].blank? ? [] : result_hash['changed_catmatch_ids'].values.flatten(1)  )
      ...
      def taobao_simba_catmatchids_deleted_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['deleted_catmatch_ids'] = ( result_hash['deleted_catmatch_ids'].blank? ? [] : result_hash['deleted_catmatch_ids'].values.flatten(1)  )
      ...
      def taobao_simba_creativeids_changed_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['changed_creative_ids'] = ( result_hash['changed_creative_ids'].blank? ? [] : result_hash['changed_creative_ids'].values.flatten(1)  )
      ...
      def taobao_simba_creativeids_deleted_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['deleted_creative_ids'] = ( result_hash['deleted_creative_ids'].blank? ? [] : result_hash['deleted_creative_ids'].values.flatten(1)  )
      ...
      def taobao_simba_creatives_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['creatives'] = ( result_hash['creatives'].blank? ? [] : result_hash['creatives']['creative'] )
      ...
      def taobao_simba_creatives_record_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['creativerecords'] = ( result_hash['creativerecords'].blank? ? [] : result_hash['creativerecords']['creative_record'] )
      ...
      def taobao_simba_customers_authorized_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['nicks'] = ( result_hash['nicks'].blank? ? [] : result_hash['nicks'].values.flatten(1)  )
      ...
      def taobao_simba_insight_cats_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['in_category_tops'] = ( result_hash['in_category_tops'].blank? ? [] : result_hash['in_category_tops']['in_category_top'] )
      ...
      def taobao_simba_insight_catsanalysis_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['in_category_analyses'] = ( result_hash['in_category_analyses'].blank? ? [] : result_hash['in_category_analyses']['in_category_analysis'] )
      ...
      def taobao_simba_insight_catsbase_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['in_category_bases'] = ( result_hash['in_category_bases'].blank? ? [] : result_hash['in_category_bases']['in_category_base'] )
      ...
      def taobao_simba_insight_catsrelatedword_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['related_words'] = ( result_hash['related_words'].blank? ? [] : result_hash['related_words'].values.flatten(1)  )
      ...
      def taobao_simba_insight_catstopword_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['top_words'] = ( result_hash['top_words'].blank? ? [] : result_hash['top_words'].values.flatten(1)  )
      ...
      def taobao_simba_insight_wordsanalysis_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['in_word_analyses'] = ( result_hash['in_word_analyses'].blank? ? [] : result_hash['in_word_analyses']['in_word_analysis'] )
      ...
      def taobao_simba_insight_wordsbase_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['in_word_bases'] = ( result_hash['in_word_bases'].blank? ? [] : result_hash['in_word_bases']['in_word_base'] )
      ...
      def taobao_simba_insight_wordscats_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['in_word_categories'] = ( result_hash['in_word_categories'].blank? ? [] : result_hash['in_word_categories']['in_word_category'] )
      ...
      def taobao_simba_keywordids_changed_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['changed_keyword_ids'] = ( result_hash['changed_keyword_ids'].blank? ? [] : result_hash['changed_keyword_ids'].values.flatten(1)  )
      ...
      def taobao_simba_keywordids_deleted_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['deleted_keyword_ids'] = ( result_hash['deleted_keyword_ids'].blank? ? [] : result_hash['deleted_keyword_ids'].values.flatten(1)  )
      ...
      def taobao_simba_keywords_add(params)
        ...
        result_hash = Client.execute(params)
        result_hash['keywords'] = ( result_hash['keywords'].blank? ? [] : result_hash['keywords']['keyword'] )
      ...
      def taobao_simba_keywords_qscore_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['keyword_qscore_list'] = ( result_hash['keyword_qscore_list'].blank? ? [] : result_hash['keyword_qscore_list']['keyword_qscore'] )
      ...
      def taobao_simba_nonsearch_adgroupplaces_add(params)
        ...
        result_hash = Client.execute(params)
        result_hash['adgroup_place_list'] = ( result_hash['adgroup_place_list'].blank? ? [] : result_hash['adgroup_place_list']['ad_group_place'] )
      ...
      def taobao_simba_nonsearch_alldemographics_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['demographic_list'] = ( result_hash['demographic_list'].blank? ? [] : result_hash['demographic_list']['demographic'] )
      ...
      def taobao_simba_nonsearch_allplaces_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['place_list'] = ( result_hash['place_list'].blank? ? [] : result_hash['place_list']['place'] )
      ...
      def taobao_simba_nonsearch_demographics_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['demographic_setting_list'] = ( result_hash['demographic_setting_list'].blank? ? [] : result_hash['demographic_setting_list']['demographic_setting'] )
      ...
      def taobao_simba_tools_items_top_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['rankeditems'] = ( result_hash['rankeditems'].blank? ? [] : result_hash['rankeditems']['ranked_item'] )
      ...
      def taobao_favorite_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['collect_items'] = ( result_hash['collect_items'].blank? ? [] : result_hash['collect_items']['collect_item'] )
      ...
      def taobao_trip_jipiao_agent_order_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['orders'] = ( result_hash['orders'].blank? ? [] : result_hash['orders']['at_order'] )
      ...
      def taobao_marketing_promotions_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['promotions'] = ( result_hash['promotions'].blank? ? [] : result_hash['promotions']['promotion'] )
      ...
      def taobao_marketing_tags_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['user_tags'] = ( result_hash['user_tags'].blank? ? [] : result_hash['user_tags']['user_tag'] )

        result_hash
      end

      def taobao_promotion_activity_add(params)
        params['method'] = 'taobao.promotion.activity.add'
        required_check_result = ["coupon_count", "coupon_id", "person_limit_count"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_promotion_activity_cancel(params)
        params['method'] = 'taobao.promotion.activity.cancel'
        required_check_result = ["activity_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_promotion_activity_delete(params)
        params['method'] = 'taobao.promotion.activity.delete'
        required_check_result = ["activity_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_promotion_activity_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['activitys'] = ( result_hash['activitys'].blank? ? [] : result_hash['activitys']['activity'] )

        result_hash
      end

      def taobao_promotion_coupon_add(params)
        params['method'] = 'taobao.promotion.coupon.add'
        required_check_result = ["denominations", "end_time"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_promotion_coupon_send(params)
        params['method'] = 'taobao.promotion.coupon.send'
        required_check_result = ["buyer_nick", "coupon_id"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['coupon_results'] = ( result_hash['coupon_results'].blank? ? [] : result_hash['coupon_results']['coupon_result'] )
        result_hash['failure_buyers'] = ( result_hash['failure_buyers'].blank? ? [] : result_hash['failure_buyers']['error_message'] )

        result_hash
      end

      def taobao_promotion_coupon_transfer(params)
        params['method'] = 'taobao.promotion.coupon.transfer'
        required_check_result = ["coupon_number", "receiveing_buyer_name"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_promotion_coupondetail_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['coupon_details'] = ( result_hash['coupon_details'].blank? ? [] : result_hash['coupon_details']['coupon_detail'] )
      ...
      def taobao_promotion_coupons_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['coupons'] = ( result_hash['coupons'].blank? ? [] : result_hash['coupons']['coupon'] )
      ...
      def taobao_promotion_limitdiscount_detail_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['item_discount_detail_list'] = ( result_hash['item_discount_detail_list'].blank? ? [] : result_hash['item_discount_detail_list']['limit_discount_detail'] )
      ...
      def taobao_promotion_limitdiscount_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['limit_discount_list'] = ( result_hash['limit_discount_list'].blank? ? [] : result_hash['limit_discount_list']['limit_discount'] )
      ...
      def taobao_promotion_meal_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['meal_list'] = ( result_hash['meal_list'].blank? ? [] : result_hash['meal_list']['meal'] )
      ...
      def taobao_ump_activities_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['contents'] = ( result_hash['contents'].blank? ? [] : result_hash['contents'].values.flatten(1)  )
      ...
      def taobao_ump_activities_list_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['activities'] = ( result_hash['activities'].blank? ? [] : result_hash['activities'].values.flatten(1)  )
      ...
      def taobao_ump_detail_list_add(params)
        ...
        result_hash = Client.execute(params)
        result_hash['detail_id_list'] = ( result_hash['detail_id_list'].blank? ? [] : result_hash['detail_id_list'].values.flatten(1)  )
      ...
      def taobao_ump_mbbs_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['mbbs'] = ( result_hash['mbbs'].blank? ? [] : result_hash['mbbs'].values.flatten(1)  )
      ...
      def taobao_ump_range_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['ranges'] = ( result_hash['ranges'].blank? ? [] : result_hash['ranges']['range'] )
      ...
      def taobao_ump_tools_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['tools'] = ( result_hash['tools'].blank? ? [] : result_hash['tools'].values.flatten(1)  )
      ...
      def taobao_hotel_orders_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['hotel_orders'] = ( result_hash['hotel_orders'].blank? ? [] : result_hash['hotel_orders']['hotel_order'] )
      ...
      def taobao_hotel_rooms_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['rooms'] = ( result_hash['rooms'].blank? ? [] : result_hash['rooms']['room'] )
      ...
      def taobao_hotel_rooms_update(params)
        ...
        result_hash = Client.execute(params)
        result_hash['gids'] = ( result_hash['gids'].blank? ? [] : result_hash['gids'].values.flatten(1)  )
      ...
      def taobao_hotel_sold_hotels_increment_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['hotels'] = ( result_hash['hotels'].blank? ? [] : result_hash['hotels']['hotel'] )
      ...
      def taobao_hotel_sold_types_increment_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['room_types'] = ( result_hash['room_types'].blank? ? [] : result_hash['room_types']['room_type'] )
      ...
      def taobao_juwliserver_jutou_items_get(params)
        params['method'] = 'taobao.juwliserver.jutou.items.get'
        required_check_result = ["page_no", "page_size", "request_type", "request_version"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?

        result_hash = Client.execute(params)
        result_hash['results'] = ( result_hash['results'].blank? ? [] : result_hash['results']['ju_item_mo'] )
      ...
      def taobao_picture_category_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['picture_categories'] = ( result_hash['picture_categories'].blank? ? [] : result_hash['picture_categories']['picture_category'] )
      ...
      def taobao_picture_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['pictures'] = ( result_hash['pictures'].blank? ? [] : result_hash['pictures']['picture'] )
      ...
      def taobao_picture_referenced_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['references'] = ( result_hash['references'].blank? ? [] : result_hash['references']['reference_detail'] )
      ...
      def taobao_sellercenter_rolemembers_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['subusers'] = ( result_hash['subusers'].blank? ? [] : result_hash['subusers']['sub_user_info'] )
      ...
      def taobao_sellercenter_roles_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['roles'] = ( result_hash['roles'].blank? ? [] : result_hash['roles']['role'] )
      ...
      def taobao_sellercenter_user_permissions_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['permissions'] = ( result_hash['permissions'].blank? ? [] : result_hash['permissions']['permission'] )

        result_hash
      end

      def taobao_fuwu_sale_link_gen(params)
        params['method'] = 'taobao.fuwu.sale.link.gen'
        required_check_result = ["param_str"] - params.keys.map(&:to_s)
        raise "#{required_check_result.inspect} 为应用级必填参数,不能为空" unless required_check_result.empty?
      ...
      def taobao_vas_order_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['article_biz_orders'] = ( result_hash['article_biz_orders'].blank? ? [] : result_hash['article_biz_orders']['article_biz_order'] )
      ...
      def taobao_vas_subsc_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['article_subs'] = ( result_hash['article_subs'].blank? ? [] : result_hash['article_subs']['article_sub'] )
      ...
      def taobao_vas_subscribe_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['article_user_subscribes'] = ( result_hash['article_user_subscribes'].blank? ? [] : result_hash['article_user_subscribes']['article_user_subscribe'] )
      ...
      def taobao_refund_messages_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['refund_messages'] = ( result_hash['refund_messages'].blank? ? [] : result_hash['refund_messages']['refund_message'] )
      ...
      def taobao_refunds_apply_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['refunds'] = ( result_hash['refunds'].blank? ? [] : result_hash['refunds']['refund'] )
      ...
      def taobao_categoryrecommend_items_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['favorite_items'] = ( result_hash['favorite_items'].blank? ? [] : result_hash['favorite_items']['favorite_item'] )
      ...
      def taobao_itemrecommend_items_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['values'] = ( result_hash['values'].blank? ? [] : result_hash['values']['favorite_item'] )
      ...
      def taobao_shoprecommend_shops_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['favorite_shops'] = ( result_hash['favorite_shops'].blank? ? [] : result_hash['favorite_shops']['favorite_shop'] )
      ...
      def alipay_user_account_freeze_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['freeze_items'] = ( result_hash['freeze_items'].blank? ? [] : result_hash['freeze_items']['account_freeze'] )
      ...
      def alipay_user_contract_get(params)
        ...
        special_params = ["subscriber_user_id"]
        special_check_result = special_params - params.keys.map(&:to_s)
        raise "#{special_params.inspect} 为应用级特殊参数,具体请查看此API文档" if special_params.size == special_check_result.size
      ...
      def alipay_user_trade_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['trade_records'] = ( result_hash['trade_records'].blank? ? [] : result_hash['trade_records']['trade_record'] )
      ...
      def tmall_items_discount_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['brand_list'] = ( result_hash['brand_list'].blank? ? [] : result_hash['brand_list']['tmall_brand'] )
        result_hash['cat_list'] = ( result_hash['cat_list'].blank? ? [] : result_hash['cat_list']['tmall_cat'] )
        result_hash['item_list'] = ( result_hash['item_list'].blank? ? [] : result_hash['item_list']['tmall_search_item'] )
        result_hash['minisite_list'] = ( result_hash['minisite_list'].blank? ? [] : result_hash['minisite_list']['tmall_minisite'] )
      ...
      def tmall_selected_items_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['item_list'] = ( result_hash['item_list'].blank? ? [] : result_hash['item_list']['selected_item'] )
      ...
      def tmall_temai_items_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['item_list'] = ( result_hash['item_list'].blank? ? [] : result_hash['item_list']['tmall_search_tm_item'] )
      ...
      def tmall_temai_subcats_search(params)
        ...
        result_hash = Client.execute(params)
        result_hash['cat_list'] = ( result_hash['cat_list'].blank? ? [] : result_hash['cat_list']['tmall_tm_cat'] )
      ...
      def taobao_rds_db_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['rds_db_infos'] = ( result_hash['rds_db_infos'].blank? ? [] : result_hash['rds_db_infos']['rds_db_info'] )
      ...
      def taobao_caipiao_lotterytypes_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['results'] = ( result_hash['results'].blank? ? [] : result_hash['results']['lottery_type'] )
      ...
      def taobao_caipiao_present_items_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['results'] = ( result_hash['results'].blank? ? [] : result_hash['results']['lottery_wangcai_present'] )
      ...
      def taobao_caipiao_present_stat_get(params)
        ...
        result_hash = Client.execute(params)
        result_hash['results'] = ( result_hash['results'].blank? ? [] : result_hash['results']['lottery_wangcai_present_stat'] )
